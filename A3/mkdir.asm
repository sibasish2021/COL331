...
main(int argc, char *argv[])
{
  ...
  18:	81 c3 d0 0b 00 00    	add    $0xbd0,%ebx
  ...
  28:	8d 83 20 fd ff ff    	lea    -0x2e0(%ebx),%eax
  2e:	50                   	push   %eax
  2f:	6a 02                	push   $0x2
  ...
  5b:	50                   	push   %eax
  5c:	e8 74 03 00 00       	call   3d5 <mkdir>
  ...
  7c:	50                   	push   %eax
  7d:	8d 83 37 fd ff ff    	lea    -0x2c9(%ebx),%eax
  83:	50                   	push   %eax
  84:	6a 02                	push   $0x2
...
stosb(void *addr, int data, int cnt)
{
  ...
  ae:	05 3a 0b 00 00       	add    $0xb3a,%eax
...
strcpy(char *s, const char *t)
{
  ...
  df:	05 09 0b 00 00       	add    $0xb09,%eax
  char *os;
...
strcmp(const char *p, const char *q)
{
 ...
 116:	05 d2 0a 00 00       	add    $0xad2,%eax
  while(*p && *p == *q)
...
strlen(const char *s)
{
 ...
 162:	05 86 0a 00 00       	add    $0xa86,%eax
  int n;
...
memset(void *dst, int c, uint n)
{
 ...
 190:	05 58 0a 00 00       	add    $0xa58,%eax
  stosb(dst, c, n);
...
strchr(const char *s, char c)
{
 ...
 1b7:	05 31 0a 00 00       	add    $0xa31,%eax
...
gets(char *buf, int max)
{
 ...
 1f5:	81 c3 f3 09 00 00    	add    $0x9f3,%ebx
  int i, cc;
  char c;
...
stat(const char *n, struct stat *st)
{
 ...
 273:	81 c3 75 09 00 00    	add    $0x975,%ebx
  int fd;
  int r;
...
atoi(const char *s)
{
 ...
 2ce:	05 1a 09 00 00       	add    $0x91a,%eax
  int n;
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 325:	05 c3 08 00 00       	add    $0x8c3,%eax
  char *dst;
  const char *src;
...
putc(int fd, char c)
{
 ...
 421:	05 c7 07 00 00       	add    $0x7c7,%eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 454:	81 c1 94 07 00 00    	add    $0x794,%ecx
...
printf(int fd, const char *fmt, ...)
{
 ...
 515:	81 c3 d3 06 00 00    	add    $0x6d3,%ebx
  char *s;
  int c, i, state;
  uint *ap;
 ...
 5ed:	75 27                	jne    616 <printf+0x10d>
          s = "(null)";
 5ef:	8d 83 53 fd ff ff    	lea    -0x2ad(%ebx),%eax
...
free(void *ap)
{
 ...
 6bb:	05 2d 05 00 00       	add    $0x52d,%eax
  Header *bp, *p;
...
morecore(uint nu)
{
 ...
 7aa:	81 c3 3e 04 00 00    	add    $0x43e,%ebx
  char *p;
  Header *hp;
...
malloc(uint nbytes)
{
 ...
 81a:	81 c3 ce 03 00 00    	add    $0x3ce,%ebx
  Header *p, *prevp;
  uint nunits;
